...
class _RestClient implements RestClient {
  _RestClient(
    ...
    baseUrl ??=
        'https://g5l4ib2lcd.execute-api.ap-southeast-1.amazonaws.com/dev';
  }
  ...
  @override
  Future<List<PostResponse>> getPosts(token) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<PostResponse> getPostById(
    token,
    id,
  ) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<PaymentResponse> upgradeToPremium(token) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
